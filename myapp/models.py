...
class Product(models.Model):
    ...
    stock = models.PositiveIntegerField(default=100, validators=[MinValueValidator(0, "too Less"), MaxValueValidator(1000, "too more")])
...
class Client(User):
    ...
    # client_img = models.ImageField(upload_to='images')
