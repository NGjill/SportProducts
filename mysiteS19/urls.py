...
urlpatterns = [
    ...
    url(r'^myapp/index', views.index.as_view(), name='index'),
    ...
    url(r'^myapp/reset/', views.reset, name='reset'),
    # url(r'^myapp/client_image_view', 'views.client_image_view', name='client_img')
]
